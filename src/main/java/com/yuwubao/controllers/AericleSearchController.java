...
public class AericleSearchController {
    ...
    public RestApiResponse<Boolean> createIndex(){
        RestApiResponse<Boolean> result = new RestApiResponse<>();
        try {
            CreateIndexResponse createIndexResponse = this.client.admin().indices().prepareCreate("zk").get();
    ...
    public RestApiResponse<Boolean> addMapping() {
        ...
        try {
            ...
            PutMappingRequest mappingRequest = Requests.putMappingRequest("zk").source(builder).type("article");
    ...
    public RestApiResponse<Boolean> deleteIndex() {
        RestApiResponse<Boolean> result = new RestApiResponse<Boolean>();
        try {
