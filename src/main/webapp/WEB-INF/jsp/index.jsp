	...
	<div class="wu-header" data-options="region:'north',border:false,split:true">
        <div class="wu-header-left">
            <div style="float: left">
                <img src="../../images/zkLogo.jpg" style="width: 27px;height: 27px;margin-top: 9px;">
            </div>
            <div style="float: right">
                <h2 style="color: #FFFFFF">湖北智库网后台管理系统</h2>
            </div>
        </div>
        ...
        <div id="wu-tabs" class="easyui-tabs" data-options="border:false,fit:true">  
            <div title="首页" data-options="closable:false,iconCls:'icon-tip',cls:'pd3'">
                <div style="text-align: center">
                    <img src="../../images/zkLogo.jpg" style="width: 35%;height: 35%">
                </div>
            </div>
        </div>
    </div>
